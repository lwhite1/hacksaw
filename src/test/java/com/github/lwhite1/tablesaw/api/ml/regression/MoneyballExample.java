...
public class MoneyballExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DoubleColumn wins = moneyball.numericColumn("W");
        DoubleColumn year = moneyball.numericColumn("Year");
        ...
        DoubleColumn runDifference = moneyball.nCol("RS").subtract(moneyball.nCol("RA"));
