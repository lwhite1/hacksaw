...
public class FxBar extends FxBuilder {
    ...
    public static BarChart<String, Number> chart(String title, Table table, String categoryColumnName, String
        ...
        DoubleColumn numericColumn = table.nCol(numericColumnName);

        return chart(title, categoryColumn, numericColumn);
    }

    public static BarChart<String, Number> chart(String title, CategoryColumn categoryColumn, DoubleColumn
            numericColumn) {
    ...
    public static BarChart<String, Number> chart(String title, DoubleColumn categoryColumn, DoubleColumn numericColumn) {
